...
( () => {
    ...
    function g(l) {
        l = l.replaceAll("\r\n", "\n");
        let s, c = [], v = c, k = !1, w = [], b = null, y = "";
        function x(e=v) {
            return 1 === e.length ? e[0] : k ? t(e) : r(e)
        }
        function $(e) {
            let t = v[v.length - 1];
            "compound" === t?.kind ? t.nodes.push(e) : t && "list" !== t.kind && "combinator" !== t.kind ? v[v.length - 1] = r([t, e]) : v.push(e)
        }
        for (let r = 0; r < l.length; r++) {
            ...
            case 44:
                for (y.length > 0 && ($(i(y)),
                y = ""); r + 1 < l.length && (s = l.charCodeAt(r + 1),
                10 === s || 32 === s || 9 === s); r++)
                    ;
                if (b)
                    b.nodes.push(x()),
            ...
            case 126:
                {
                    ...
                    let t = r
                      , n = r + 1;
                    for (; n < l.length && (s = l.charCodeAt(n),
                    62 === s || 10 === s || 32 === s || 43 === s || 9 === s || 126 === s); n++)
                        ;
                    r = n - 1;
            ...
            case 40:
                {
                    let e = n(y, []);
                    if (y = "",
                    ":not" !== e.value && ":where" !== e.value && ":has" !== e.value && ":is" !== e.value) {
                        let t = r + 1
                          , n = 0;
                        ...
                        if (":nth-child" === e.value || ":nth-last-child" === e.value) {
                            let t = i.indexOf("of ");
                            if (-1 !== t) {
                                e.nodes.push(a(i.slice(0, t + 3)), ...g(i.slice(t + 3))),
                                y = "",
                                r = o,
                                $(e);
                                break
    ...
    function b(e, t) {
        ...
        "\ufeff" === e[0] && (e = " " + e.slice(1));
        let n, o = [], i = [], a = [], l = null, s = null, c = "", u = "", d = 0;
        for (let t = 0; t < e.length; t++) {
            let f = e.charCodeAt(t);
            if (13 !== f || (n = e.charCodeAt(t + 1),
            n !== k))
                if (92 === f)
                    "" === c && (d = t),
                    c += e.slice(t, t + 2),
    ...
    var S = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-decoration-color", "--text-decoration-thickness", "--text-indent", "--text-shadow", "--text-underline-offset"]], ["--grid-column", ["--grid-column-start", "--grid-column-end"]], ["--grid-row", ["--grid-row-start", "--grid-row-end"]]]);
    function C(e, t) {
    ...
    function U(e) {
        ...
        return i.length > 0 && r.push(E(i)),
        r
    }
    var W, R = ((W = R || {})[W.Continue = 0] = "Continue",
    W[W.Skip = 1] = "Skip",
    W[W.Stop = 2] = "Stop",
    ...
    function B(e, t= () => D.Continue, r= () => D.Continue) {
        ...
        for (; null !== n; ) {
            ...
            a >= 0) {
                ...
                switch (l.kind) {
                case 0:
                    r.nodes && r.nodes.length > 0 && (o.depth += 1,
                    n = {
                        value: [r.nodes, 0, r],
                        prev: n
                    }),
                ...
                case 4:
                    ...
                    continue;
                default:
                    throw new Error(`Invalid \`WalkAction.${R[l.kind] ?? `Unknown(${l.kind})`}\` in enter.`)
                }
            }
            let s = ~a;
            o.index = s;
            ...
            case 3:
            case 4:
                i.splice(s, 1, ...c.nodes),
                e[1] = s + c.nodes.length;
                continue;
            case 5:
                return void i.splice(s, 1, ...c.nodes);
            default:
                throw new Error(`Invalid \`WalkAction.${R[c.kind] ?? `Unknown(${c.kind})`}\` in exit.`)
            }
        }
    }
    var M = new j(e => {
    ...
    function ee(e, t, r=3) {
            ...
            if ("declaration" === e.kind) {
                ...
                if ("animation" === e.property)
                    for (let t of ae(e.value))
                        d.add(t);
                2 & r && !s.supportsColorMix && !s.keyframes && e.value.includes("color-mix(") && a.get(l).add(e),
                l.push(e)
            } else if ("rule" === e.kind) {
                let t = [];
                ...
                "@keyframes" === e.name ? s = {
                    ...s,
                    keyframes: !0
                } : "@supports" === e.name && e.params.includes("color-mix(") && (s = {
                    ...s,
                    supportsColorMix: !0
                });
                let t = {
                ...
                (t.nodes.length > 0 || "@layer" === t.name || "@charset" === t.name || "@custom-media" === t.name || "@namespace" === t.name || "@import" === t.name || "@apply" === t.name) && l.push(t)
            ...
            for (let[e,r] of a)
                for (let n of r) {
                    ...
                    let a = {
                      ...
                      , l = H("@supports (color: color-mix(in lab, red, red))", [n]);
                    l.src = n.src,
                    e.splice(r, 1, a, l)
                }
        if (1 & r) {
            ...
            if (e.length > 0) {
                let t = v.findIndex(e => !("comment" === e.kind || "at-rule" === e.kind && ("@charset" === e.name || "@import" === e.name)))
                  , r = P("@layer", "properties", []);
                r.src = e[0].src,
                v.splice(t < 0 ? v.length : t, 0, r);
        ...
        return function(e) {
                        ...
                        0 === r.length)
                            if (e.selector.includes("&")) {
                                let t = g(e.selector)
                                  , n = !1;
                                L(t, e => {
                                    "selector" === e.kind && "&" === e.value && (n = !0,
                                    e.value = ":scope")
                                }
                                ),
                                n ? r.push([c(t), e.src, e.dst]) : r.push([e.selector, e.src, e.dst])
                            } else
                            ...
                            let n = r[r.length - 1][0]
                              , o = V(e.selector, ",").map(e => {
                                ...
                                }
                                {
                                    ...
                                    if (L(r, {
                                        enter(e, r) {
                                            if ("selector" !== e.kind || "&" !== e.value || (o = !0,
                                            e.value = `:is(${n})`,
                                            null === r.parent))
                                                return;
                                            let i = t.get(n);
                                            if (1 !== i.length || "list" !== i[0].kind) {
                                        ...
                                        exit(e, t) {
                                            if (0 === t.index && t.siblings.length > 1 && "compound" === t.parent?.kind && l(e)) {
                                                let e = t.siblings[1];
            ...
            function f(e) {
                if (o)
                    return "declaration" === e.kind && (i.has(e.property) ? a.add(o) : i.add(e.property)),
                    void o.push(e);
                {
    ...
    var te = new Set(["@container", "@layer", "@media", "@page", "@starting-style", "@supports", "@view-transition"])
      , re = new Set(["@container", "@media", "@page", "@starting-style", "@supports", "@view-transition"]);
    function ne(e, t) {
        let r = 0
          , n = {
            file: null,
    ...
    var le = ["calc", "min", "max", "clamp", "mod", "rem", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "pow", "sqrt", "hypot", "log", "exp", "round"];
    function se(e) {
        return -1 !== e.indexOf("(") && le.some(t => e.includes(`${t}(`))
    }
    function ce(e) {
        if (!le.some(t => e.includes(t)))
            return e;
        let t = ""
          , r = []
          , n = null
    ...
    function ve(e) {
        ...
        return "(" === e[0] && ")" === e[e.length - 1] ? "-" === (e = e.slice(1, -1))[0] && "-" === e[1] && me(e) ? {
            kind: "arbitrary",
            value: ue(e = `var(${e})`)
        } : null : ge.test(e) ? {
            kind: "named",
    ...
    function we(e) {
        ...
        let t = Se(e.value)
          ...
          , [n,o] = t ? ["(", ")"] : ["[", "]"];
        return "arbitrary" === e.kind ? `/${n}${xe(r)}${o}` : "named" === e.kind ? `/${e.value}` : ""
    }
    function be(e) {
        if ("static" === e.kind)
            return e.root;
        ...
        t += "-",
        t += be(e.variant)),
        ("functional" === e.kind || "compound" === e.kind) && (t += we(e.modifier)),
        t
    }
    var ye = new j(e => {
        let t = U(e)
        ...
        return L(t, (e, t) => {
            if ("word" === e.kind && n.has(e.value)) {
                ...
                return i && !n.has(i.value) ? void 0 : D.ReplaceSkip({
                    kind: "function",
                    value: "",
                    nodes: [e]
                })
    ...
    var $e = new j(e => {
        let t = U(e);
        return 3 === t.length && "word" === t[0].kind && "&" === t[0].value && "separator" === t[1].kind && ":" === t[1].value && "function" === t[2].kind && "is" === t[2].value ? F(t[2].nodes) : e
    }
    );
    function ze(e) {
        for (let t of e)
    ...
    var Ke = /^(?<value>[-+]?(?:\d*\.)?\d+)(?<unit>[a-z]+|%)?$/i
      ...
      , Ne = /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix|--alpha)\(/i;
    var Oe = {
        color: function(e) {
            return 35 === e.charCodeAt(0) || Ne.test(e) || Ee.has(e.toLowerCase())
        },
        length: Ye,
        percentage: Ie,
        ratio: function(e) {
        ...
        "line-width": function(e) {
            return V(e, " ").every(e => Ye(e) || Me(e) || "thin" === e || "medium" === e || "thick" === e)
        },
        image: function(e) {
            let t = 0;
            for (let r of V(e, ","))
    ...
    var Pe = new RegExp(`^${Le.source}(${["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"].join("|")})$`)
      , He = /^(--spacing)\(/i;
    function Ye(e) {
        return Pe.test(e) || He.test(e) || se(e)
    }
    var Ze = new RegExp(`^${Le.source}(${["deg", "rad", "grad", "turn"].join("|")})$`);
    ...
    var rt = new Set(["inset", "inherit", "initial", "revert", "unset"])
      ...
      , ot = new Set(["color", "color-mix", "contrast-color", "device-cmyk", "hsl", "hsla", "hwb", "lab", "lch", "light-dark", "oklab", "oklch", "rgb", "rgba", "--alpha"])
      , it = /^-?(\d+|\.\d+)(.*?)$/;
    function at(e, t) {
        function r(e) {
            let r = F([e]);
        ...
        return V(e, ",").map(e => {
            ...
            return L(n, e => {
                ...
                case "word":
                    ...
                    break;
                case "function":
                    return ot.has(e.value.toLowerCase()) ? (l = !0,
                    D.ReplaceStop(r(e))) : nt.has(e.value.toLowerCase()) ? (a++,
                    D.Skip) : (o = e,
                    i++,
                    D.Skip);
                case "separator":
            ...
            l ? F(n) : a < 2 ? e : 0 === i ? `${e} ${t("currentcolor")}` : (1 === i && L(n, e => e === o ? (l = !0,
            D.ReplaceStop(r(e))) : D.Skip),
            l ? F(n) : e)
        }
        ).join(", ")
    }
    var lt = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"]
      , st = class {
        utilities = new j( () => []);
        completions = new Map;
        static(e, t) {
    ...
    ;
    function ct(e, t, r) {
        return P("@property", e, [Y("syntax", r ? `"${r}"` : '"*"'), Y("inherits", "false"), ...t ? [Y("initial-value", t)] : []])
    }
    function ut(e, t) {
        if (null === t)
            return e;
            ...
            L(e.nodes, e => {
                ...
                L(t, e => {
                    ...
                    for (let[e,r] of t.entries())
                        ...
                        r = r.replace(/\s+/g, ""),
                        r = r.replace(/(-\*){2,}/g, "-*"),
                        "-" === r[0] && "-" === r[1] && !r.includes("(") && !r.includes("-*") && (r += "-*"),
                        t[e] = r;
                    e.nodes = U(t.join(","));
                    for (let t of e.nodes)
    ...
    function kt(e, t, r, n, o="") {
        let i = !1
          , a = at(t, e => null == r ? n(e) : e.startsWith("current") ? n(ut(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (i = !0),
        n(dt(e, r))));
        function l(e) {
            return o ? V(e, ",").map(e => o.trim() + " " + e.trim()).join(", ") : e
        }
        return i ? [Y(e, l(at(t, n))), H("@supports (color: lab(from red l a b))", [Y(e, l(a))])] : [Y(e, l(a))]
    }
    function wt(e, t, r, n, o="") {
        let i = !1
          , a = V(t, ",").map(e => at(e, e => null == r ? n(e) : e.startsWith("current") ? n(ut(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (i = !0),
        n(dt(e, r))))).map(e => `drop-shadow(${e})`).join(" ");
        return i ? [Y(e, o + V(t, ",").map(e => `drop-shadow(${at(e, n)})`).join(" ")), H("@supports (color: lab(from red l a b))", [Y(e, o + a)])] : [Y(e, o + a)]
    }
    ...
    var Nt = new RegExp(Object.keys(Et).map(e => `${e}\\(`).join("|"));
    function Ot(e, t) {
        let r = 0;
        return L(e, e => {
            if ("declaration" === e.kind && e.value && Nt.test(e.value))
                return r |= 8,
                void (e.value = Ft(e.value, e, t));
            "at-rule" === e.kind && ("@media" === e.name || "@custom-media" === e.name || "@container" === e.name || "@supports" === e.name) && Nt.test(e.params) && (r |= 8,
            e.params = Ft(e.params, e, t))
        }
        ),
        r
    }
    ...
    function Mt(e, t) {
        L(e, e => "at-rule" === e.kind && "@slot" === e.name ? D.ReplaceSkip(t) : "at-rule" !== e.kind || "@keyframes" !== e.name && "@property" !== e.name ? void 0 : (Object.assign(e, J([P(e.name, e.params, e.nodes)])),
        D.Skip))
    }
    function _t(e, t) {
        let r = 0;
        return L(e, e => {
            ...
            for (let[r,i] of o.entries()) {
                let a = q("&", r === o.length - 1 ? e.nodes : e.nodes.map(X))
                  , l = V(i, ":");
    ...
    function It(e, t) {
        let r = function(e) {
            ...
            function o(n, o) {
                function i({negative: t}) {
                    return r => {
                        ...
                        if (null !== n)
                            return o.handle(t ? ce(`calc(${n} * -1)`) : n, i)
                    }
                }
                if (o.staticValues && (o.staticValues = Object.assign(Object.create(null), o.staticValues)),
            ...
            function i(n, o) {
                t.functional(n, t => {
                    ...
                    r = ft(r, t.modifier, e)) : r = pt(t, e, o.themeKeys),
            ...
            function a(n, i, a, {supportsNegative: l=!1, supportsFractions: s=!1, staticValues: c}={}) {
                ...
                o(n, {
                    ...
                    supportsNegative: l,
                    defaultValue: null,
                    handleBareValue: ({value: t}) => e.resolve(null, ["--spacing"]) && Qe(t) ? `--spacing(${t})` : null,
                    handleNegativeBareValue: ({value: t}) => e.resolve(null, ["--spacing"]) && Qe(t) ? `--spacing(-${t})` : null,
                    handle: a,
                    staticValues: c
                }),
                r(n, () => [{
            ...
            for (let[e,t] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["inset-s", "inset-inline-start"], ["inset-e", "inset-inline-end"], ["inset-bs", "inset-block-start"], ["inset-be", "inset-block-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]])
                n(`${e}-auto`, [[t, "auto"]]),
                n(`${e}-full`, [[t, "100%"]]),
                n(`-${e}-full`, [[t, "-100%"]]),
            ...
            for (let[e,t] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mbs", "margin-block-start"], ["mbe", "margin-block-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]])
                n(`${e}-auto`, [[t, "auto"]]),
            ...
            o("line-clamp", {
                ...
                staticValues: {
                    none: [Y("overflow", "visible"), Y("display", "block"), Y("-webkit-box-orient", "horizontal"), Y("-webkit-line-clamp", "unset")]
                }
            }),
            r("line-clamp", () => [{
                values: ["1", "2", "3", "4", "5", "6"],
            ...
            a("size", ["--size", "--spacing"], e => [Y("--tw-sort", "size"), Y("width", e), Y("height", e)], {
                supportsFractions: !0
            });
            ...
            for (let[e,t] of [["full", "100%"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]])
            ...
            for (let[e,t] of [["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"]])
                n(`inline-${e}`, [["inline-size", t]]),
                n(`min-inline-${e}`, [["min-inline-size", t]]),
                n(`max-inline-${e}`, [["max-inline-size", t]]);
            for (let[e,t] of [["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"]])
                n(`block-${e}`, [["block-size", t]]),
                n(`min-block-${e}`, [["min-block-size", t]]),
                n(`max-block-${e}`, [["max-block-size", t]]);
            ...
            for (let[e,t,r] of [["inline", ["--spacing", "--container"], "inline-size"], ["min-inline", ["--spacing", "--container"], "min-inline-size"], ["max-inline", ["--spacing", "--container"], "max-inline-size"], ["block", ["--spacing"], "block-size"], ["min-block", ["--spacing"], "min-block-size"], ["max-block", ["--spacing"], "max-block-size"]])
                a(e, t, e => [Y(r, e)], {
                    supportsFractions: !0
                });
            t.static("container", () => {
                ...
                for (let e of t)
                    r.push(P("@media", `(width >= ${e})`, [Y("max-width", e)]));
                return r
            }
            ),
            ...
            let l = () => J([ct("--tw-border-spacing-x", "0", "<length>"), ct("--tw-border-spacing-y", "0", "<length>")]);
            a("border-spacing", ["--border-spacing", "--spacing"], e => [l(), Y("--tw-border-spacing-x", e), Y("--tw-border-spacing-y", e), Y("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
            a("border-spacing-x", ["--border-spacing", "--spacing"], e => [l(), Y("--tw-border-spacing-x", e), Y("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
            a("border-spacing-y", ["--border-spacing", "--spacing"], e => [l(), Y("--tw-border-spacing-y", e), Y("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")]),
            o("origin", {
                ...
                staticValues: {
                    ...
                    "bottom-right": [Y("transform-origin", "100% 100%")],
            ...
            o("perspective-origin", {
                ...
                staticValues: {
                    ...
                    "bottom-right": [Y("perspective-origin", "100% 100%")],
            ...
            o("perspective", {
                ...
                staticValues: {
                    none: [Y("perspective", "none")]
                }
            });
            let s = () => J([ct("--tw-translate-x", "0"), ct("--tw-translate-y", "0"), ct("--tw-translate-z", "0")]);
            ...
            n("translate-full", [s, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
            a("translate", ["--translate", "--spacing"], e => [s(), Y("--tw-translate-x", e), Y("--tw-translate-y", e), Y("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
                supportsNegative: !0,
                supportsFractions: !0
            });
            for (let e of ["x", "y"])
                ...
                n(`translate-${e}-full`, [s, [`--tw-translate-${e}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]),
                a(`translate-${e}`, ["--translate", "--spacing"], t => [s(), Y(`--tw-translate-${e}`, t), Y("translate", "var(--tw-translate-x) var(--tw-translate-y)")], {
                    supportsNegative: !0,
                    supportsFractions: !0
                });
            a("translate-z", ["--translate", "--spacing"], e => [s(), Y("--tw-translate-z", e), Y("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")], {
                supportsNegative: !0
            }),
            n("translate-3d", [s, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
            let c = () => J([ct("--tw-scale-x", "1"), ct("--tw-scale-y", "1"), ct("--tw-scale-z", "1")]);
            function u({negative: t}) {
                return r => {
                    ...
                    n = t ? `calc(${n} * -1)` : n,
                    [Y("scale", n)]) : (n = e.resolve(r.value.value, ["--scale"]),
                    !n && Je(r.value.value) && (n = `${r.value.value}%`),
                    n ? (n = t ? `calc(${n} * -1)` : n,
                    [c(), Y("--tw-scale-x", n), Y("--tw-scale-y", n), Y("--tw-scale-z", n), Y("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
                }
            }
            ...
            }]);
            {
                let e = ["var(--tw-rotate-x,)", "var(--tw-rotate-y,)", "var(--tw-rotate-z,)", "var(--tw-skew-x,)", "var(--tw-skew-y,)"].join(" ")
                  , i = () => J([ct("--tw-rotate-x"), ct("--tw-rotate-y"), ct("--tw-rotate-z"), ct("--tw-skew-x"), ct("--tw-skew-y")]);
                for (let t of ["x", "y", "z"])
                    o(`rotate-${t}`, {
                        supportsNegative: !0,
                        themeKeys: ["--rotate"],
            ...
            let f = () => J([ct("--tw-pan-x"), ct("--tw-pan-y"), ct("--tw-pinch-zoom")]);
            ...
            let p = () => J([ct("--tw-scroll-snap-strictness", "proximity", "*")]);
            ...
            a("space-x", ["--space", "--spacing"], e => {
                let t = ( () => {
                    if ("--spacing(0)" === e || "--spacing(-0)" === e)
                        return !0;
                    let t = Ve.get(e);
                    return !(!t || 0 !== t[0] || null !== t[1] && !Ye(e))
                }
                )();
                return [J([ct("--tw-space-x-reverse", "0")]), q(":where(& > :not(:last-child))", [Y("--tw-sort", "row-gap"), Y("--tw-space-x-reverse", "0"), Y("margin-inline-start", t ? "0" : `calc(${e} * var(--tw-space-x-reverse))`), Y("margin-inline-end", t ? "0" : `calc(${e} * calc(1 - var(--tw-space-x-reverse)))`)])]
            }
            , {
                supportsNegative: !0
            }),
            a("space-y", ["--space", "--spacing"], e => {
                ...
                return [J([ct("--tw-space-y-reverse", "0")]), q(":where(& > :not(:last-child))", [Y("--tw-sort", "column-gap"), Y("--tw-space-y-reverse", "0"), Y("margin-block-start", t ? "0" : `calc(${e} * var(--tw-space-y-reverse))`), Y("margin-block-end", t ? "0" : `calc(${e} * calc(1 - var(--tw-space-y-reverse)))`)])]
            }
            , {
                supportsNegative: !0
            }),
            n("space-x-reverse", [ () => J([ct("--tw-space-x-reverse", "0")]), () => q(":where(& > :not(:last-child))", [Y("--tw-sort", "row-gap"), Y("--tw-space-x-reverse", "1")])]),
            n("space-y-reverse", [ () => J([ct("--tw-space-y-reverse", "0")]), () => q(":where(& > :not(:last-child))", [Y("--tw-sort", "column-gap"), Y("--tw-space-y-reverse", "1")])]),
            ...
            i("divide", {
                ...
                handle: e => [q(":where(& > :not(:last-child))", [Y("--tw-sort", "divide-color"), Y("border-color", e)])]
            }),
            ...
            n("scrollbar-none", [["scrollbar-width", "none"]]);
            {
                ...
                i("scrollbar-thumb", {
                    themeKeys: ["--color"],
                    handle: t => [e(), Y("--tw-scrollbar-thumb", t), Y("scrollbar-color", "var(--tw-scrollbar-thumb) var(--tw-scrollbar-track)")]
                }),
                i("scrollbar-track", {
                    themeKeys: ["--color"],
                    handle: t => [e(), Y("--tw-scrollbar-track", t), Y("scrollbar-color", "var(--tw-scrollbar-thumb) var(--tw-scrollbar-track)")]
                })
            }
            n("scrollbar-gutter-auto", [["scrollbar-gutter", "auto"]]),
            n("scrollbar-gutter-stable", [["scrollbar-gutter", "stable"]]),
            n("scrollbar-gutter-both", [["scrollbar-gutter", "stable both-edges"]]),
            ...
            n("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
            {
                ...
                i("border-bs", {
                    width: e => [Y("border-block-start-style", "var(--tw-border-style)"), Y("border-block-start-width", e)],
                    color: e => [Y("border-block-start-color", e)]
                }),
                i("border-be", {
                    width: e => [Y("border-block-end-style", "var(--tw-border-style)"), Y("border-block-end-width", e)],
                ...
                o("divide-x", {
                    ...
                    handle: e => [J([ct("--tw-divide-x-reverse", "0")]), q(":where(& > :not(:last-child))", [Y("--tw-sort", "divide-x-width"), a(), Y("--tw-divide-x-reverse", "0"), Y("border-inline-style", "var(--tw-border-style)"), Y("border-inline-start-width", `calc(${e} * var(--tw-divide-x-reverse))`), Y("border-inline-end-width", `calc(${e} * calc(1 - var(--tw-divide-x-reverse)))`)])]
                }),
                o("divide-y", {
                    defaultValue: e.get(["--default-border-width"]) ?? "1px",
                    themeKeys: ["--divide-width", "--border-width"],
                    handleBareValue: ({value: e}) => Je(e) ? `${e}px` : null,
                    handle: e => [J([ct("--tw-divide-y-reverse", "0")]), q(":where(& > :not(:last-child))", [Y("--tw-sort", "divide-y-width"), a(), Y("--tw-divide-y-reverse", "0"), Y("border-bottom-style", "var(--tw-border-style)"), Y("border-top-style", "var(--tw-border-style)"), Y("border-top-width", `calc(${e} * var(--tw-divide-y-reverse))`), Y("border-bottom-width", `calc(${e} * calc(1 - var(--tw-divide-y-reverse)))`)])]
                }),
                r("divide-x", () => [{
                    values: ["0", "2", "4", "8"],
                ...
                n("divide-x-reverse", [ () => J([ct("--tw-divide-x-reverse", "0")]), () => q(":where(& > :not(:last-child))", [Y("--tw-divide-x-reverse", "1")])]),
                n("divide-y-reverse", [ () => J([ct("--tw-divide-y-reverse", "0")]), () => q(":where(& > :not(:last-child))", [Y("--tw-divide-y-reverse", "1")])]);
            ...
            o("bg-position", {
                handle(e) {
                    if (e)
                        return [Y("background-position", e)]
                }
            }),
            ...
            n("bg-none", [["background-image", "none"]]);
            {
                let e = function(e) {
                    ...
                    return r => {
                        ...
                        if ("arbitrary" === r.value.kind) {
                            if (r.modifier)
                                return;
                            let e = r.value.value;
                            return "angle" === (r.value.dataType ?? Fe(e, ["angle"])) ? (e = t ? `calc(${e} * -1)` : `${e}`,
                            [Y("--tw-gradient-position", e), Y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]) : t ? void 0 : [Y("--tw-gradient-position", e), Y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]
                        }
                        let n = r.value.value;
                        if (!t && a.has(n))
                            n = a.get(n);
                        ...
                        let o = e(r.modifier);
                        return [Y("--tw-gradient-position", `${n}`), H("@supports (background-image: linear-gradient(in lab, red, red))", [Y("--tw-gradient-position", `${n} ${o}`)]), Y("background-image", "linear-gradient(var(--tw-gradient-stops))")]
                    }
                }
                  , o = function({negative: t}) {
                    return r => {
                        ...
                        let n = e(r.modifier);
                        if (!r.value)
                            return [Y("--tw-gradient-position", n), Y("background-image", "conic-gradient(var(--tw-gradient-stops))")];
                        let o = r.value.value;
                        return Je(o) ? (o = t ? `calc(${o}deg * -1)` : `${o}deg`,
                        [Y("--tw-gradient-position", `from ${o} ${n}`), Y("background-image", "conic-gradient(var(--tw-gradient-stops))")]) : void 0
                    }
                }
                ...
                t.functional("bg-radial", t => {
                    if (!t.value)
                        return [Y("--tw-gradient-position", e(t.modifier)), Y("background-image", "radial-gradient(var(--tw-gradient-stops))")];
                    if ("arbitrary" === t.value.kind) {
                        if (t.modifier)
                            return;
                        let e = t.value.value;
            ...
            let g = () => J([ct("--tw-mask-linear", "linear-gradient(#fff, #fff)"), ct("--tw-mask-radial", "linear-gradient(#fff, #fff)"), ct("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
            function v(n, o) {
                t.functional(n, t => {
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            ...
                            case "color":
                                ...
                                null === r ? void 0 : o.color(r);
                            case "percentage":
                                return t.modifier || !Je(r.slice(0, -1)) ? void 0 : o.position(r);
                            default:
                                return t.modifier ? void 0 : o.position(r)
                            }
                        }
                        ...
                        }
                        {
                            ...
                            switch (r) {
                            case "number":
                                return e.resolve(null, ["--spacing"]) && Qe(t.value.value) ? o.position(`--spacing(${t.value.value})`) : void 0;
                            case "percentage":
                                return Je(t.value.value.slice(0, -1)) ? o.position(t.value.value) : void 0;
                            default:
                                return
                            }
                        }
            ...
            let k = () => J([ct("--tw-mask-left", "linear-gradient(#fff, #fff)"), ct("--tw-mask-right", "linear-gradient(#fff, #fff)"), ct("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), ct("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
            function w(e, t, r) {
                v(e, {
                    color(e) {
                        let n = [g(), k(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
                        for (let o of ["top", "right", "bottom", "left"])
                            r[o] && (n.push(Y(`--tw-mask-${o}`, `linear-gradient(to ${o}, var(--tw-mask-${o}-from-color) var(--tw-mask-${o}-from-position), var(--tw-mask-${o}-to-color) var(--tw-mask-${o}-to-position))`)),
                            n.push(J([ct(`--tw-mask-${o}-from-position`, "0%"), ct(`--tw-mask-${o}-to-position`, "100%"), ct(`--tw-mask-${o}-from-color`, "black"), ct(`--tw-mask-${o}-to-color`, "transparent")])),
            ...
            let b = () => J([ct("--tw-mask-linear-position", "0deg"), ct("--tw-mask-linear-from-position", "0%"), ct("--tw-mask-linear-to-position", "100%"), ct("--tw-mask-linear-from-color", "black"), ct("--tw-mask-linear-to-color", "transparent")]);
            o("mask-linear", {
                defaultValue: null,
                supportsNegative: !0,
                supportsFractions: !1,
                ...
                handle: e => [g(), b(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))"), Y("--tw-mask-linear-position", e)]
            }),
            r("mask-linear", () => [{
                supportsNegative: !0,
                values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
            ...
            let y = () => J([ct("--tw-mask-radial-from-position", "0%"), ct("--tw-mask-radial-to-position", "100%"), ct("--tw-mask-radial-from-color", "black"), ct("--tw-mask-radial-to-color", "transparent"), ct("--tw-mask-radial-shape", "ellipse"), ct("--tw-mask-radial-size", "farthest-corner"), ct("--tw-mask-radial-position", "center")]);
            ...
            o("mask-radial", {
                ...
                supportsNegative: !1,
                supportsFractions: !1,
                handle: e => [g(), y(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))"), Y("--tw-mask-radial-size", e)]
            }),
            v("mask-radial-from", {
                color: e => [g(), y(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), Y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), Y("--tw-mask-radial-from-color", e)],
                position: e => [g(), y(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), Y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), Y("--tw-mask-radial-from-position", e)]
            }),
            v("mask-radial-to", {
                color: e => [g(), y(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), Y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), Y("--tw-mask-radial-to-color", e)],
                position: e => [g(), y(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), Y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), Y("--tw-mask-radial-to-position", e)]
            });
            let x = () => J([ct("--tw-mask-conic-position", "0deg"), ct("--tw-mask-conic-from-position", "0%"), ct("--tw-mask-conic-to-position", "100%"), ct("--tw-mask-conic-from-color", "black"), ct("--tw-mask-conic-to-color", "transparent")]);
            o("mask-conic", {
                defaultValue: null,
                supportsNegative: !0,
                supportsFractions: !1,
                ...
                handle: e => [g(), x(), Y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), Y("mask-composite", "intersect"), Y("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops, var(--tw-mask-conic-position)))"), Y("--tw-mask-conic-position", e)]
            }),
            r("mask-conic", () => [{
                supportsNegative: !0,
                values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
            ...
            t.functional("stroke", t => {
                if (t.value) {
                    if ("arbitrary" === t.value.kind) {
                        ...
                        default:
                            return r = ft(t.value.value, t.modifier, e),
            ...
            o("object", {
                ...
                staticValues: {
                    ...
                    "bottom-left": [Y("object-position", "left bottom")],
                    "bottom-right": [Y("object-position", "right bottom")],
                    left: [Y("object-position", "left")],
                    right: [Y("object-position", "right")],
                    center: [Y("object-position", "center")]
                }
            });
            for (let[e,t] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pbs", "padding-block-start"], ["pbe", "padding-block-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]])
            ...
            t.functional("font", t => {
                if (t.value && !t.modifier) {
                    if ("arbitrary" === t.value.kind) {
                        ...
                        default:
                            return [J([ct("--tw-font-weight")]), Y("--tw-font-weight", e), Y("font-weight", e)]
                        }
                    }
                    {
            ...
            i("placeholder", {
                ...
                handle: e => [q("&::placeholder", [Y("--tw-sort", "placeholder-color"), Y("color", e)])]
            }),
            ...
            });
            {
                let i = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" ")
                  ...
                  , l = () => J([ct("--tw-blur"), ct("--tw-brightness"), ct("--tw-contrast"), ct("--tw-grayscale"), ct("--tw-hue-rotate"), ct("--tw-invert"), ct("--tw-opacity"), ct("--tw-saturate"), ct("--tw-sepia"), ct("--tw-drop-shadow"), ct("--tw-drop-shadow-color"), ct("--tw-drop-shadow-alpha", "100%", "<percentage>"), ct("--tw-drop-shadow-size")])
                  , s = () => J([ct("--tw-backdrop-blur"), ct("--tw-backdrop-brightness"), ct("--tw-backdrop-contrast"), ct("--tw-backdrop-grayscale"), ct("--tw-backdrop-hue-rotate"), ct("--tw-backdrop-invert"), ct("--tw-backdrop-opacity"), ct("--tw-backdrop-saturate"), ct("--tw-backdrop-sepia")]);
                ...
                o("blur", {
                    ...
                    staticValues: {
                        none: [l(), Y("--tw-blur", " "), Y("filter", i)]
                    }
                }),
                o("backdrop-blur", {
                    themeKeys: ["--backdrop-blur", "--blur"],
                    handle: e => [s(), Y("--tw-backdrop-blur", `blur(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)],
                    staticValues: {
                        none: [s(), Y("--tw-backdrop-blur", " "), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                    }
                }),
                o("brightness", {
                ...
                o("backdrop-brightness", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    handle: e => [s(), Y("--tw-backdrop-brightness", `brightness(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("brightness", () => [{
                    values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
                ...
                o("backdrop-contrast", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    handle: e => [s(), Y("--tw-backdrop-contrast", `contrast(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("contrast", () => [{
                ...
                o("backdrop-grayscale", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    defaultValue: "100%",
                    handle: e => [s(), Y("--tw-backdrop-grayscale", `grayscale(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("grayscale", () => [{
                ...
                o("backdrop-hue-rotate", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}deg` : null,
                    handle: e => [s(), Y("--tw-backdrop-hue-rotate", `hue-rotate(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("hue-rotate", () => [{
                ...
                o("backdrop-invert", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    defaultValue: "100%",
                    handle: e => [s(), Y("--tw-backdrop-invert", `invert(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("invert", () => [{
                    values: ["0", "25", "50", "75", "100"],
                ...
                o("backdrop-saturate", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    handle: e => [s(), Y("--tw-backdrop-saturate", `saturate(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("saturate", () => [{
                ...
                o("backdrop-sepia", {
                    ...
                    handleBareValue: ({value: e}) => Je(e) ? `${e}%` : null,
                    defaultValue: "100%",
                    handle: e => [s(), Y("--tw-backdrop-sepia", `sepia(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("sepia", () => [{
                    values: ["0", "50", "100"],
                ...
                t.functional("drop-shadow", t => {
                    let r;
                    if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : et(t.modifier.value) && (r = `${t.modifier.value}%`)),
                    !t.value) {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? Fe(n, ["color"])) ? (n = ft(n, t.modifier, e),
                        null === n ? void 0 : [l(), Y("--tw-drop-shadow-color", ut(n, "var(--tw-drop-shadow-alpha)")), Y("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]) : t.modifier && !r ? void 0 : [l(), Y("--tw-drop-shadow-alpha", r), ...wt("--tw-drop-shadow-size", n, r, e => `var(--tw-drop-shadow-color, ${e})`), Y("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), Y("filter", i)]
                    }
                    {
                ...
                o("backdrop-opacity", {
                    ...
                    handle: e => [s(), Y("--tw-backdrop-opacity", `opacity(${e})`), Y("-webkit-backdrop-filter", a), Y("backdrop-filter", a)]
                }),
                r("backdrop-opacity", () => [{
                    values: Array.from({
                        length: 21
            ...
            }
            {
                ...
                o("transition", {
                    ...
                    handle: e => [Y("transition-property", e), Y("transition-timing-function", i), Y("transition-duration", a)],
                    staticValues: {
                        none: [Y("transition-property", "none")],
                        all: [Y("transition-property", "all"), Y("transition-timing-function", i), Y("transition-duration", a)],
                        colors: [Y("transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"), Y("transition-timing-function", i), Y("transition-duration", a)],
                        opacity: [Y("transition-property", "opacity"), Y("transition-timing-function", i), Y("transition-duration", a)],
                        shadow: [Y("transition-property", "box-shadow"), Y("transition-timing-function", i), Y("transition-duration", a)],
                        transform: [Y("transition-property", "transform, translate, scale, rotate"), Y("transition-timing-function", i), Y("transition-duration", a)]
                    }
                }),
                ...
                });
                {
                    ...
                    t.functional("duration", t => {
                        ...
                        null === n && Je(t.value.value) && (n = `${t.value.value}ms`)),
            ...
            }
            {
                ...
                o("ease", {
                    ...
                    staticValues: {
                        ...
                        linear: [e(), Y("--tw-ease", "linear"), Y("transition-timing-function", "linear")]
                    }
                })
            }
            ...
            o("content", {
                themeKeys: ["--content"],
                handle: e => [J([ct("--tw-content", '""')]), Y("--tw-content", e), Y("content", "var(--tw-content)")]
            });
            {
                let e = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)"
                  , t = () => J([ct("--tw-contain-size"), ct("--tw-contain-layout"), ct("--tw-contain-paint"), ct("--tw-contain-style")]);
            ...
            a("leading", ["--leading", "--spacing"], e => [J([ct("--tw-leading")]), Y("--tw-leading", e), Y("line-height", e)], {
                staticValues: {
                    none: [J([ct("--tw-leading")]), Y("--tw-leading", "1"), Y("line-height", "1")]
                }
            }),
            o("tracking", {
                supportsNegative: !0,
                themeKeys: ["--tracking"],
                handle: e => [J([ct("--tw-tracking")]), Y("--tw-tracking", e), Y("letter-spacing", e)]
            }),
            ...
            n("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
            {
                let e = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)"
                  , t = () => J([ct("--tw-ordinal"), ct("--tw-slashed-zero"), ct("--tw-numeric-figure"), ct("--tw-numeric-spacing"), ct("--tw-numeric-fraction")]);
            ...
            }
            {
                ...
                t.static("outline-hidden", () => [Y("--tw-outline-style", "none"), Y("outline-style", "none"), P("@media", "(forced-colors: active)", [Y("outline", "2px solid transparent"), Y("outline-offset", "2px")])]),
                        ...
                        if (r) {
                            ...
                            if (t.modifier) {
                                ...
                                !r)
                                    return null;
                                let o = [Y("font-size", n)];
                                return r && o.push(Y("line-height", r)),
                                o
                            }
            ...
            let $ = () => J([ct("--tw-text-shadow-color"), ct("--tw-text-shadow-alpha", "100%", "<percentage>")]);
            ...
            t.functional("text-shadow", t => {
                ...
                if ("arbitrary" === t.value.kind) {
                    let n = t.value.value;
                    return "color" === (t.value.dataType ?? Fe(n, ["color"])) ? (n = ft(n, t.modifier, e),
                    null === n ? void 0 : [$(), Y("--tw-text-shadow-color", ut(n, "var(--tw-text-shadow-alpha)"))]) : [$(), Y("--tw-text-shadow-alpha", r), ...kt("text-shadow", n, r, e => `var(--tw-text-shadow-color, ${e})`)]
                }
                switch (t.value.value) {
                case "none":
                    return t.modifier ? void 0 : [$(), Y("text-shadow", "none")];
                case "inherit":
                    return t.modifier ? void 0 : [$(), Y("--tw-text-shadow-color", "inherit")]
                }
                {
            ...
            }]);
            {
                let o = function(e) {
                  ...
                  , l = "0 0 #0000"
                  , s = () => J([ct("--tw-shadow", l), ct("--tw-shadow-color"), ct("--tw-shadow-alpha", "100%", "<percentage>"), ct("--tw-inset-shadow", l), ct("--tw-inset-shadow-color"), ct("--tw-inset-shadow-alpha", "100%", "<percentage>"), ct("--tw-ring-color"), ct("--tw-ring-shadow", l), ct("--tw-inset-ring-color"), ct("--tw-inset-ring-shadow", l), ct("--tw-ring-inset"), ct("--tw-ring-offset-width", "0px", "<length>"), ct("--tw-ring-offset-color", "#fff"), ct("--tw-ring-offset-shadow", l)]);
                ...
                t.functional("shadow", t => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? Fe(n, ["color"])) ? (n = ft(n, t.modifier, e),
                        null === n ? void 0 : [s(), Y("--tw-shadow-color", ut(n, "var(--tw-shadow-alpha)"))]) : [s(), Y("--tw-shadow-alpha", r), ...kt("--tw-shadow", n, r, e => `var(--tw-shadow-color, ${e})`), Y("box-shadow", a)]
                    }
                    switch (t.value.value) {
                    case "none":
                ...
                t.functional("inset-shadow", t => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? Fe(n, ["color"])) ? (n = ft(n, t.modifier, e),
                        null === n ? void 0 : [s(), Y("--tw-inset-shadow-color", ut(n, "var(--tw-inset-shadow-alpha)"))]) : [s(), Y("--tw-inset-shadow-alpha", r), ...kt("--tw-inset-shadow", n, r, e => `var(--tw-inset-shadow-color, ${e})`, "inset"), Y("box-shadow", a)]
                    }
                    switch (t.value.value) {
                    case "none":
                        return t.modifier ? void 0 : [s(), Y("--tw-inset-shadow", `inset ${l}`), Y("box-shadow", a)];
                    case "inherit":
                ...
                t.functional("ring", t => {
                    ...
                    if ("arbitrary" === t.value.kind) {
                        let r = t.value.value;
                        return "length" === (t.value.dataType ?? Fe(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), Y("--tw-ring-shadow", o(r)), Y("box-shadow", a)] : (r = ft(r, t.modifier, e),
                    ...
                    }
                    {
                        ...
                        if (null === r && Je(t.value.value) && (r = `${t.value.value}px`),
                        r)
                            return [s(), Y("--tw-ring-shadow", o(r)), Y("box-shadow", a)]
                    }
                }
                ...
                t.functional("inset-ring", t => {
                    if (!t.value)
                        return t.modifier ? void 0 : [s(), Y("--tw-inset-ring-shadow", i("1px")), Y("box-shadow", a)];
                    if ("arbitrary" === t.value.kind) {
                        let r = t.value.value;
                        return "length" === (t.value.dataType ?? Fe(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), Y("--tw-inset-ring-shadow", i(r)), Y("box-shadow", a)] : (r = ft(r, t.modifier, e),
                ...
                t.functional("ring-offset", t => {
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            return "length" === (t.value.dataType ?? Fe(r, ["color", "length"])) ? t.modifier ? void 0 : [Y("--tw-ring-offset-width", r), Y("--tw-ring-offset-shadow", u)] : (r = ft(r, t.modifier, e),
            ...
            t.functional("@container", e => {
                let t = null;
                if (null === e.value ? t = "inline-size" : "arbitrary" === e.value.kind ? t = e.value.value : "named" === e.value.kind && "normal" === e.value.value ? t = "normal" : "named" === e.value.kind && "size" === e.value.value && (t = "size"),
                null !== t)
                    return e.modifier ? [Y("container-type", t), Y("container-name", e.modifier.value)] : [Y("container-type", t)]
            }
            ),
            r("@container", () => [{
                values: ["normal"],
          ...
          , n = function(e) {
            ...
            function n(e, t) {
                return t.map(t => {
                    if ("@container" === e) {
                        let e = U(t.trim());
                        return e.length >= 1 && "function" === e[0].kind ? `not ${t}` : e.length >= 3 && "word" === e[0].kind && "not" === e[0].value && "function" === e[2].kind ? (e.splice(0, 2),
                        F(e)) : e.length >= 5 && "word" === e[0].kind && "word" === e[2].kind && "not" === e[2].value && "function" === e[4].kind ? (e.splice(2, 2),
                        F(e)) : e.length >= 3 && "word" === e[0].kind && "not" !== e[0].value && "function" === e[2].kind ? (e.splice(1, 0, {
                            kind: "separator",
                            value: " "
                        }, {
                            kind: "word",
            ...
            function a(e) {
                return e.includes("::") ? null : `&:not(${V(e, ",").map(e => e.replaceAll("&", "*")).join(", ")})`
            }
            ...
            {
                let e = function() {
                    return J([P("@property", "--tw-content", [Y("syntax", '"*"'), Y("initial-value", '""'), Y("inherits", "false")])])
                };
                t.static("before", t => {
                    t.nodes = [q("&::before", [e(), Y("content", "var(--tw-content)"), ...t.nodes])]
                }
                , {
                    compounds: 0
                }),
                t.static("after", t => {
                    t.nodes = [q("&::after", [e(), Y("content", "var(--tw-content)"), ...t.nodes])]
                }
                , {
                    compounds: 0
                })
            ...
            t.static("hover", e => {
                e.nodes = [q("&:hover", [P("@media", "(hover: hover)", e.nodes)])]
            }
            ),
            r("focus", ["&:focus"]),
            ...
            t.functional("nth", (e, t) => {
                if (!t.value || t.modifier || "named" === t.value.kind && !Je(t.value.value))
                    return null;
            ...
            t.functional("nth-last", (e, t) => {
                if (!t.value || t.modifier || "named" === t.value.kind && !Je(t.value.value))
                    return null;
                e.nodes = [q(`&:nth-last-child(${t.value.value})`, e.nodes)]
            }
            ),
            t.functional("nth-of-type", (e, t) => {
                if (!t.value || t.modifier || "named" === t.value.kind && !Je(t.value.value))
                    return null;
                e.nodes = [q(`&:nth-of-type(${t.value.value})`, e.nodes)]
            }
            ),
            t.functional("nth-last-of-type", (e, t) => {
                if (!t.value || t.modifier || "named" === t.value.kind && !Je(t.value.value))
                    return null;
                e.nodes = [q(`&:nth-last-of-type(${t.value.value})`, e.nodes)]
            }
            ),
            ...
            r("contrast-less", ["@media (prefers-contrast: less)"]);
            {
                let r = function(e, t, r, n) {
                    ...
                    if (null === o)
                        return "asc" === r ? -1 : 1;
                    let i = n.get(t);
                    return null === i ? "asc" === r ? 1 : -1 : je(o, i, r)
                };
                {
                    ...
                    t.group( () => {
                        t.functional("max", (e, t) => {
                            ...
                            if (null === r)
                                return null;
                            e.nodes = [P("@media", `(width < ${r})`, e.nodes)]
                        }
                        , {
                            compounds: 1
                        })
                    ...
                    t.group( () => {
                        for (let[r,n] of e.namespace("--breakpoint"))
                            null !== r && t.static(r, e => {
                                e.nodes = [P("@media", `(width >= ${n})`, e.nodes)]
                            }
                            , {
                                compounds: 1
                            });
                ...
                }
                {
                    ...
                    t.group( () => {
                        t.functional("@max", (e, t) => {
                            ...
                            if (null === r)
                                return null;
                            e.nodes = [P("@container", t.modifier ? `${t.modifier.value} (width < ${r})` : `(width < ${r})`, e.nodes)]
                        }
                        , {
                            compounds: 1
                        })
                    ...
                    case "functional":
                        {
                            ...
                            if ("]" === r[r.length - 1]) {
                                ...
                                return me(n) && 0 !== n.length && 0 !== n.trim().length ? {
                                    kind: "functional",
                                    root: e,
                                    modifier: t,
                                    value: {
                            ...
                            if (")" === r[r.length - 1]) {
                                if ("(" !== r[0])
                                    continue;
                                let n = ue(r.slice(1, -1));
                                return me(n) && 0 !== n.length && 0 !== n.trim().length && "-" === n[0] && "-" === n[1] ? {
                                    kind: "functional",
                                    root: e,
                                    modifier: t,
                                    value: {
          ...
          , i = new j(e => Array.from(function*(e, t) {
            let r = V(e, ":");
            if (t.theme.prefix) {
          ...
          , a = new j(e => new j(t => {
            let r = function(e, t, r) {
                let n = function(e, t) {
                    if ("arbitrary" === e.kind) {
                        let r = e.value;
                        return e.modifier && (r = ft(r, e.modifier, t.theme)),
        ...
        let c = {
            ...
            printCandidate: e => function(e, t) {
                ...
                return "arbitrary" === t.kind && (n += `[${t.property}:${xe(t.value)}]`),
                ("arbitrary" === t.kind || "functional" === t.kind) && (n += we(t.modifier)),
                t.important && (n += "!"),
                r.push(n),
                r.join(":")
            }(c, e),
            ...
            getVariantOrder() {
                ...
                let t, r = new Map, n = 0;
                for (let o of e)
                    null !== o && (void 0 !== t && 0 !== this.variants.compare(t, o) && n++,
                    r.set(o, n),
                    t = o);
                return r
            },
    ...
    function Ht(e, t, r, n=0) {
        if ("arbitrary" === t.kind)
            return t.relative && 0 === n ? null : void (e.nodes = [H(t.selector, e.nodes)]);
    ...
    function Zt(e) {
        for (let t of e)
            "at-root" !== t.kind && ("declaration" === t.kind ? t.important = !0 : ("rule" === t.kind || "at-rule" === t.kind) && Zt(t.nodes))
    }
    function Gt(e) {
        let t = new Set
          , r = 0
        ...
        function u(e, r=[]) {
            if (!l.has(e)) {
                if (c.has(e)) {
                    ...
                    throw "at-rule" === e.kind && "@utility" === e.name && "at-rule" === n.kind && "@utility" === n.name && L(e.nodes, e => {
                        if ("at-rule" !== e.kind || "@apply" !== e.name)
                            return;
        ...
        for (let e of s)
            "nodes"in e && L(e.nodes, e => {
                ...
                for (let[e,t] of r.entries())
                    e % 2 == 0 && ("-" === t[0] && "-" === t[1] ? i.push(t) : o.push(t),
                    n[t] = a),
                    a += t.length;
                if (i.length) {
                    if (0 === o.length)
    ...
    async function Qt(e, t, r, n=0, o=!1) {
        ...
        return L(e, e => {
            if ("at-rule" === e.kind && ("@import" === e.name || "@reference" === e.name)) {
                ...
                return a.push((async () => {
                    if (n > 100)
                        throw new Error(`Exceeded maximum recursion depth while resolving \`${s}\` in \`${t}\`)`);
                    let i = await r(s, t)
                      , a = b(i.content, {
    ...
    function tr(e, {theme: t}, r) {
        ...
        if (Object.hasOwn(t, "fontFamily")) {
            let r = 5;
            {
                ...
                e.theme.add("--default-font-feature-settings", er(t.fontFamily.sans, "fontFeatureSettings") ?? "normal", r),
                e.theme.add("--default-font-variation-settings", er(t.fontFamily.sans, "fontVariationSettings") ?? "normal", r))
            }
            {
                let n = er(t.fontFamily.mono);
                n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, r),
                e.theme.add("--default-mono-font-feature-settings", er(t.fontFamily.mono, "fontFeatureSettings") ?? "normal", r),
                e.theme.add("--default-mono-font-variation-settings", er(t.fontFamily.mono, "fontVariationSettings") ?? "normal", r))
            }
        }
        return t
    }
    ...
    function ir(e) {
        ...
        for (let t of e)
            if (!or.test(t))
                return null;
        let r = nr[e[0]];
        return r && ((e = e.slice())[0] = r),
        e.map( (e, t, r) => "1" === e && t !== r.length - 1 ? "" : e).map( (e, t) => (e = e.replaceAll(".", "_"),
        (0 === t || e.startsWith("-") || "lineHeight" === e) && (e = e.replace(/([a-z])([A-Z])/g, (e, t, r) => `${t}-${r.toLowerCase()}`)),
        ...
        for (let o of t)
            if (null != o)
                for (let t of Reflect.ownKeys(o)) {
                    n.push(t);
                    let i = r(e[t], o[t], n);
                    void 0 !== i ? e[t] = i : sr(e[t]) && sr(o[t]) ? e[t] = cr({}, [e[t], o[t]], r, n) : e[t] = o[t],
                    n.pop()
                }
        return e
    }
        ...
        return function(n, o) {
            ...
            let l = ( () => {
                let o = lr(n)
                  ...
                  , l = r(dr(t() ?? {}, o) ?? null);
                if ("string" == typeof l && (l = l.replace("<alpha-value>", "1")),
                "object" != typeof i)
                ...
                return null !== i && "object" == typeof i && !Array.isArray(i) && "DEFAULT"in i ? i.DEFAULT : i ?? l
            }
            )();
            return a && "string" == typeof l && (l = ut(l, a)),
            l ?? o
        }
    }
    function dr(e, t) {
    ...
    function hr({designSystem: e, ast: t, resolvedConfig: r, featuresRef: n, referenceMode: o, src: i}) {
        let a = {
            addBase(r) {
                if (o)
                    return;
            ...
            addUtilities(r) {
                ...
                for (let[e,r] of a) {
                    ...
                    let n = g(e)
                      , a = !1;
                    if (L(n, e => {
                        if ("selector" === e.kind && "." === e.value[0] && pr.test(e.value.slice(1))) {
                            let t = e.value;
                            e.value = "&";
                            let o = c(n)
                              , i = t.slice(1)
            ...
            matchUtilities(t, r) {
                ...
                for (let[i,a] of Object.entries(t)) {
                    let t = function({negative: t}) {
                        return l => {
                            if ("arbitrary" === l.value?.kind && o.length > 0 && !o.includes("any") && (l.value.dataType && !o.includes(l.value.dataType) || !l.value.dataType && !Fe(l.value.value, o)))
                                return;
                            let s, c = o.includes("color"), u = null, d = !1;
                            {
                                ...
                                l.value ? "arbitrary" === l.value.kind ? u = l.value.value : l.value.fraction && Object.hasOwn(e, l.value.fraction) ? (u = e[l.value.fraction],
                                d = !0) : Object.hasOwn(e, l.value.value) ? u = e[l.value.value] : e.__BARE_VALUE__ && (u = e.__BARE_VALUE__(l.value) ?? null,
    ...
    function vr(e, t, r) {
        L(e, e => {
            if ("rule" === e.kind) {
                let n = g(e.selector);
                L(n, e => {
                    "selector" === e.kind && e.value === `.${t}` && (e.value = `.${z(r)}`)
                }
                ),
                e.selector = c(n)
            }
    ...
    function Er(e, t) {
        return Array.isArray(e) && sr(e[0]) ? e.concat(t) : Array.isArray(t) && sr(t[0]) && sr(e) ? [e, ...t] : Array.isArray(t) ? t : void 0
    }
    ...
    function Or(e, t) {
        ...
        let n = function({center: e, padding: t, screens: r}, n) {
            let o = []
              , i = null;
            if (e && o.push(Y("margin-inline", "auto")),
            ("string" == typeof t || "object" == typeof t && null !== t && "DEFAULT"in t) && o.push(Y("padding-inline", "string" == typeof t ? t : t.DEFAULT)),
            "object" == typeof r && null !== r) {
                i = new Map;
                let e = Array.from(n.theme.namespace("--breakpoint").entries());
                if (e.sort( (e, t) => je(e[1], t[1], "asc")),
                e.length > 0) {
                    let[t] = e[0];
    ...
    var Wr = /^[a-z]+$/;
    async function Rr({designSystem: e, base: t, ast: r, loadModule: n, sources: o}) {
        let i = 0
          , a = []
          , l = [];
        L(r, (e, t) => {
        ...
        function(e) {
            ...
            e.utilities.static("decoration-slice", () => [Y("-webkit-box-decoration-break", "slice"), Y("box-decoration-break", "slice")]),
            e.utilities.suggest("decoration-clone", () => []),
            e.utilities.static("decoration-clone", () => [Y("-webkit-box-decoration-break", "clone"), Y("box-decoration-break", "clone")]),
            ...
            e.utilities.static("break-words", () => [Y("overflow-wrap", "break-word")]);
                ...
                let n = function({negative: t}) {
                    return n => {
                        ...
                        if (null === o && t) {
                            ...
                            if (t && Qe(n.value.value) && (o = `calc(${t} * -${n.value.value})`,
                            null !== o))
                                return [Y(r, o)]
                        }
                        if (null === o) {
        ...
        if (e.resolveThemeValue = function(n, a) {
            return n.startsWith("--") ? s(n, a) : (i |= Dr({
                designSystem: e,
                base: t,
                ast: r,
                sources: o,
    ...
    function Dr({designSystem: e, base: t, ast: r, sources: n, configs: o, pluginDetails: i}) {
        let a = 0
          , l = [...i.map(e => {
            if (!e.options)
                return {
        ...
        "string" == typeof s.important) {
            ...
            L(r, (t, r) => {
                if ("at-rule" !== t.kind || "@tailwind" !== t.name || "utilities" !== t.params)
                    return;
                let n = Q(r);
                return "rule" === n.parent?.kind && n.parent.selector === e ? D.Stop : D.ReplaceStop(q(e, [t]))
            }
            )
        }
    ...
    async function qr(e, {base: t="", from: r, loadModule: n=_r, loadStylesheet: o=Ir}={}) {
        let i = 0;
        e = [G({
            base: t
        }, e)],
        i |= await Qt(e, t, o, 0, void 0 !== r);
        let a = null
          , l = new T
          , s = new Map
          , c = new Map
        ...
        L(e, (e, t) => {
            ...
            if ("@variant" === e.name && (null === r.parent ? 0 === e.nodes.length ? e.name = "@custom-variant" : (L(e.nodes, t => {
                if ("at-rule" === t.kind && "@slot" === t.name)
                    return e.name = "@custom-variant",
                    D.Stop
            }
            ),
            "@variant" === e.name && p.push(e)) : p.push(e)),
                ...
                if (0 === e.nodes.length) {
                    ...
                    s.set(t, e => {
                        e.variants.static(t, e => {
                            let t = [];
                            o.length > 0 && t.push(q(o.join(", "), e.nodes));
                            for (let n of r)
                                t.push(H(n, e.nodes));
                            e.nodes = t
                        }
            ...
            if ("@media" === e.name) {
                ...
                for (let o of t)
                    if (o.startsWith("source(")) {
                        ...
                        "important" === o ? a = !0 : "reference" === o ? e.nodes = [G({
                            reference: !0
                        }, e.nodes)] : n.push(o);
                if (n.length > 0)
                    e.params = n.join(" ");
            ...
            if ("@theme" === e.name) {
                ...
                return L(e.nodes, r => {
                    if ("at-rule" === r.kind && "@keyframes" === r.name)
                        return l.addKeyframes(r),
                        D.Skip;
                    if ("comment" === r.kind)
                        return;
                    if ("declaration" === r.kind && r.property.startsWith("--"))
                        return void l.add(A(r.property), r.value ?? "", t, r.src);
                    let n = ne([P(e.name, e.params, [r])]).split("\n").map( (e, t, r) => `${0 === t || t >= r.length - 2 ? " " : ">"} ${e}`).join("\n");
                    throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.\n\n${n}`)
                }
                ),
                d ? D.ReplaceSkip([]) : (d = q(":root, :host", []),
                d.src = e.src,
                D.ReplaceSkip(d))
            }
        }
        ...
        for (let e of function(e, t) {
            ...
            function i(a, l=[]) {
                if (e.has(a) && !r.has(a)) {
                    n.has(a) && t.onCircularDependency?.(l, a),
                    n.add(a);
            ...
            onCircularDependency(e, t) {
                let r = ne(e.map( (r, n) => P("@custom-variant", r, [P("@variant", e[n + 1] ?? t, [])]))).replaceAll(";", " { … }").replace(`@custom-variant ${t} {`, `@custom-variant ${t} { /* ← */`);
    ...
    async function Pr(e, t={}) {
        let r = b(e, {
          ...
          , n = await async function(e, t={}) {
            let {designSystem: r, ast: n, sources: o, root: i, utilitiesNode: a, features: l, inlineCandidates: s} = await qr(e, t);
            function c(e) {
                r.invalidCandidates.add(e)
            }
            n.unshift(Z("! tailwindcss v4.3.3 | MIT License | https://tailwindcss.com "));
            let u = new Set
              , d = null
              , f = 0
              , p = !1;
        ...
        return {
            ...
            build(e) {
                let r = n.build(e);
                return r === o || (i = ne(r, !!t.from),
                o = r),
                i
            },
            buildSourceMap: () => function({ast: e}) {
    ...
    async function rn(e, t) {
        try {
            ...
            return tn.hit("Loaded stylesheet", {
                id: e,
                base: t,
            ...
            throw tn.hit("Failed to load stylesheet", {
                id: e,
                base: t,
                error: r.message ?? r
            }),
    ...
    function on(e) {
        Qr = Qr.then(async function() {
            ...
            "full" === e && await async function() {
                ...
                let e = document.querySelectorAll(`style[type="${Zr}"]`)
                  , t = "";
                for (let r of e)
                    ln(r),
                    t += r.textContent + "\n";
            ...
            await async function(e) {
                ...
                for (let e of document.querySelectorAll("[class]"))
                    for (let r of e.classList)
                        Gr.has(r) || (Gr.add(r),
                        t.add(r));
                tn.end("Collect classes", {
                    count: t.size
                }),
                (0 !== t.size || "incremental" !== e) && (tn.start("Build utilities"),
    ...
    new MutationObserver(e => {
        ...
        for (let n of e) {
            for (let e of n.addedNodes)
                e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === Zr && (ln(e),
                t++);
            for (let e of n.addedNodes)
                1 === e.nodeType && e !== Xr && r++;
            "attributes" === n.type && r++
